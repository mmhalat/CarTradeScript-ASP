...
sql="SELECT * FROM tum where aracayir=1"
...
<%if eklerim("durum")=true then%>
      ...
      <td width="7"><span class="Metin"><img src="2el_files/yonetim_ara.gif" height="16" width="6"></span></td>
      <td width="50" class="Metin"><a href="2elguncel.asp?id=<%=eklerim("id")%>" class="Metin">İncele</a></td>
    </tr>
...
<% next%>
    ...
    <tr>
      <td colspan="11" height="22"><div class="Metin" align="center"><strong><a href="2elekle.asp" class="Metin">Yeni Araç Eklemek İçin Tıklayın </a></strong></div></td>
    </tr>
