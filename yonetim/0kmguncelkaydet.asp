...
Set odeme = baglanti.Execute("UPDATE tum SET marka='" & marka & "', vitrin='" & vitrin & "', firsat='" & firsat & "', model='" & model & "', yil='" & yil & "', renk='" & renk & "', yakit='" & yakit & "', vites='" & vites & "', m_guc='" & m_guc & "', kilometre='" & kilometre & "', plaka='" & plaka & "', fiyat='" & fiyat & "', ek_bilgi='" & ek_bilgi & "', aksesuar='" & aksesuar & "',aractipi='"&aractipi"',silindirhacmi='"&silindirhacmi&"' WHERE tum.id=" & id)
set odeme=nothing
baglanti.close
