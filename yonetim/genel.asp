  ...
  <form action="default.ASP?SID=2&amp;KID=10" method="post"></form>
    ...
    <tr>
      <td height="56" colspan="11"><table border="0" cellpadding="0" cellspacing="0">	    
        <tr>
	   <td width="142" height="11" class="Metin"><a href="markaekle.asp"><strong>Marka Ekle </strong></a></td>
       </tr>
        <tr>
          <td height="11" class="Metin"><a href="mailbilgisi.asp" class="style1">Mail Bilgileri</a></td>
        </tr>
        <tr>
          <td height="22" class="Metin">&nbsp;</td>
        </tr>
        <tr>
          <td class="Metin">&nbsp;</td>
        </tr>
